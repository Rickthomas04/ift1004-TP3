...
if __name__ == '__main__':
    ...
    assert x.quatre_positions_sauts() == [Position(5, 2), Position(5, 6), Position(1, 2), Position(1, 6)]
    assert y.quatre_positions_sauts() == [Position(2, -2), Position(2, 2), Position(-2, -2), Position(-2, 2)]
    pion_1 = Position(5, 7)
    pion_2 = Position(3, 1)

    assert pion_1.positions_diagonales_haut() == [Position(4, 6), Position(4, 8)]
    assert pion_2.positions_diagonales_haut() == [Position(2, 0), Position(2, 2)]
    a = Position(1, 4)
    b = Position(6, 2)

    assert a.quatre_positions_diagonales() == [Position(2, 3), Position(2, 5), Position(0, 3), Position(0, 5)]
    assert b.quatre_positions_diagonales() == [Position(7, 1), Position(7, 3), Position(5, 1), Position(5, 3)]
